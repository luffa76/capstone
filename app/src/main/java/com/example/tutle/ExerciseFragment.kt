...
class ExerciseFragment : Fragment() {
    ...
    private val exercises1 = listOf(
        Exercise(
            "목 스트레칭 (좌우 회전)",
            "양쪽 어깨를 편안하게 유지한 상태에서 목을 천천히 좌우로 돌려줍니다. 각각의 방향으로 10~15초 정도 유지합니다. 이 운동은 경미한 거북목을 예방하고 초기 증상을 완화하는 데 도움이 됩니다.",
            R.drawable.ex1_1
        ),
        Exercise(
            "목 측면 스트레칭",
        ...
        Exercise(
            "어깨 돌리기",
            "어깨를 위로 올렸다가 뒤로 돌리고, 다시 아래로 내리는 동작을 천천히 반복합니다. 10회씩 2~3세트 수행합니다. 이 운동은 목과 어깨 주변 근육을 이완시키는 데 도움을 줍니다.",
            R.drawable.ex1_2
        ),
        Exercise(
            "목 스트레칭 (앞뒤로 기울이기)",
        ...
        Exercise(
            "흉추 스트레칭",
            "양손을 가슴 앞에서 깍지 끼고, 상체를 좌우로 천천히 돌려줍니다. 10회 반복하여 등과 목의 긴장을 풀어줍니다.",
            R.drawable.ex1_5
        ),
        Exercise(
            "목 앞뒤로 밀기",
    ...
    private val exercises2 = listOf(
        Exercise(
            "거북목 교정 운동 (턱 당기기)",
            "벽에 등을 대고 서서 턱을 살짝 당겨서 목이 곧게 펴지도록 유지합니다. 5~10초간 유지하고, 10회 반복합니다. 이 운동은 목의 올바른 정렬을 유지하는 데 도움을 줍니다.",
            R.drawable.ex2_1
        ),
        Exercise(
            "등 상부 스트레칭 (벽 밀기)",
            "양팔을 벽에 대고 팔꿈치를 편 상태에서 벽을 미는 것처럼 상체를 천천히 밀어냅니다. 10초간 유지하고, 10회 반복합니다. 이 운동은 목과 어깨의 긴장을 완화시킵니다.",
            R.drawable.ex2_2
        ),
        Exercise(
            "천장 보기 스트레칭",
    ...
    private val exercises3 = listOf(
        Exercise(
            ...
            "탄력 밴드를 머리 뒤에 걸고, 밴드를 당겨 목을 저항하면서 천천히 당겨줍니다. 10초간 유지하고, 5회 반복합니다. 이 운동은 목의 근력을 강화하는 데 효과적입니다.",
            R.drawable.ex3_1
        ),
        Exercise(
            "흉추 이완 스트레칭 (캣카우 스트레칭)",
            "네발로 엎드려서 등을 아치형으로 만들어 올렸다가, 다시 내려줍니다. 각각의 자세를 5초간 유지하며, 10회 반복합니다. 흉추와 목의 긴장을 풀어줍니다.",
            R.drawable.ex3_2
        ),
        Exercise(
            "견갑골 압박 운동",
            "양 팔을 옆으로 벌리고, 어깨 날개뼈를 중앙으로 모으듯이 당깁니다. 5초간 유지하고, 10회 반복합니다. 어깨와 목 근육을 강화하고 자세 교정에 도움을 줍니다.",
            R.drawable.ex3_3
        ),
        Exercise(
            "목 측면 스트레칭",
        ...
        Exercise(
            ...
            "등과 목을 천천히 굽혀 등을 원형으로 만들고, 다시 펴면서 턱을 당겨줍니다. 각각 10초간 유지하고, 5회 반복합니다. 디스크에 압력을 줄이는데 도움이 됩니다.",
            R.drawable.ex3_5
        ),
        Exercise(
            "목 저항 운동 (앞뒤)",
